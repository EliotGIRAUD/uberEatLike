    ...
    <header class="border-b bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/70">
      <div class="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <nav class="flex items-center gap-4 text-sm">
          <NuxtLink to="/" class="rounded border-2 border-gray-200 px-3 py-1 hover:border-[#3AF24B] transition">Accueil</NuxtLink>
          <NuxtLink to="/restaurants" class="rounded border-2 border-gray-200 px-3 py-1 hover:border-[#3AF24B] transition">Restaurants</NuxtLink>
          <NuxtLink to="/orders" class="rounded border-2 border-gray-200 px-3 py-1 hover:border-[#3AF24B] transition">Mes commandes</NuxtLink>
          <NuxtLink to="/cart" class="rounded border-2 border-gray-200 px-3 py-1 hover:border-[#3AF24B] transition">
            Panier
          ...
          <template v-if="user.isLoggedIn && user.currentUser">
            <NuxtLink to="/profile" class="rounded border-2 border-gray-200 px-3 py-1 hover:border-[#3AF24B] transition">{{ user.currentUser.name }}</NuxtLink>
